...
# Tại sao lại thêm foreign này làm gì? FK tham chiếu đến chính nó
# Tác dụng: bảng này chỉ insert được, không xóa được! Vì xóa 1 bản ghi
# thì phải xóa thằng cha trước đã, sau đó mới xóa được thằng con (vì con
# tham chiếu tới cha). Nhưng trong trường hợp này con chính là thằng cha,
# vì nó tự tham chiếu tới chính nó mà lại dùng field ID (PK)S
/*
alter table EMPLOYEE
