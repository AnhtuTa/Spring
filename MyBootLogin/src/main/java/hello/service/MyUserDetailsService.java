...
public class MyUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
		...
		List<String> roles = appRoleDAO.getRoleNames(myUser.getUserId());
		...
		return (UserDetails) new User(myUser.getUserName(), myUser.getEncrytedPassword(), grantList);
		// return new MyUserDetails(myUser.getUserId(), myUser.getUserName(),
		// myUser.getFullName(), myUser.getEncrytedPassword(), grantList);
	}
