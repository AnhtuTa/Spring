 ...
 * Chú ý: Nếu có một đối tượng có cùng ID đang được quản lý 
 * bởi Hibernate mà gọi hàm này sẽ bị Exception.
 */
public class SaveOrUpdateDetachedDemo {
	...
	/**
	 * Insert hoặc update đối tượng emp
	 * @param emp đối tượng employee đã bị detached
	 * Nếu hàm deleteOrNotDelete() return true (delete emp) thì hàm này sẽ insert emp
	 * Nếu hàm deleteOrNotDelete() return false (not delete emp) thì hàm này sẽ update emp
	 */
