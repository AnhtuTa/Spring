 ...
 * Giải thích:
	...
	Thuộc tính produces được sử dụng để quy định một URL sẽ chỉ tạo ra 
	(trả về cho người dùng) các dữ liệu với các định dạng nào. Chẳng hạn 
...
public class MainRESTController {
    ...
    // URL (có thể thêm đuôi .json hoặc .xml):
    // http://localhost:8080/SomeContextPath/employee/{empNo}[.json][.xml]
    @RequestMapping(value = "/employee/{empNo}", //
