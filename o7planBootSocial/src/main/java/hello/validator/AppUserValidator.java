...
/*
 * AppUserFormValidator được sử dụng để kiểm tra dữ 
 * liệu mà người dùng nhập vào khi đăng ký tài khoản mới.
 */
@Component
public class AppUserValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		AppUser userAccount = appUserDAO.findByUserName(form.getUserName());
		if (userAccount != null) {
