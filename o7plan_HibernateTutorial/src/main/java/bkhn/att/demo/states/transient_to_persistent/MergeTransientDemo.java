...
/*
 * Transient --> Persistent : Sử dụng merge(Object obj1)
 * hàm merge sẽ trả về 1 object có kiểu là kiểu của obj1
 * (Chính là trả về 1 bản copy của obj1)
 * 
 * merge(..) an toàn hơn so với saveOrUpdate().
 */
public class MergeTransientDemo {
	...
	private static Timekeeper saveOrUpdate_Transient(Session session, Employee emp) {
		...
		// phiên bản 3 trở lên nó đổi tên thành merge.
		...
		System.out.println("- tk4 Persistent? " + session.contains(tk4));	//false, vì vẫn là Transient

		//do vẫn là Transient nên id không được tự động sinh ra, do đó id = null
