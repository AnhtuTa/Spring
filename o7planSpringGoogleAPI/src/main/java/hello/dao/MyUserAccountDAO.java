...
import hello.form.MyUserAccountForm;
import hello.mapper.MyUserAccountMapper;
...
public class MyUserAccountDAO extends JdbcDaoSupport {
	...
	public MyUserAccount findById(String id) {
		...
		try {
			MyUserAccount userInfo = this.getJdbcTemplate().queryForObject(sql, new Object[]{id}, mapper);
			return userInfo;
