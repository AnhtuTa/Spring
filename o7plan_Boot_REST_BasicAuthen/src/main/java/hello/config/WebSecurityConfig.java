...
/*
 * Các cấu hình bảo mật sẽ được viết trong lớp WebSecurityConfig. Trong 
 * bài viết này tôi không tập trung vào "Làm thế nào để lấy được các 
 * username trong cơ sở dữ liệu", vì vậy chúng ta tạo ra 2 UserName cố 
 * định và lưu trữ trong bộ nhớ. Người dùng truy cập vào nguồn dữ liệu 
 * của REST Service sẽ đăng nhập với 1 trong 2 username này.
 */
@Configuration
@EnableWebSecurity
