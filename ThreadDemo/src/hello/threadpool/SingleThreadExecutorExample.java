...
/**
 * Tạo ra ThreadPool sử dụng phương thức newSingleThreadExecutor(), vì vậy kích thước của ThreadPool
 * là 1, nên nó sẽ bắt đầu thực thi chương trình trên với 1 task và các task khác sẽ ở trạng thái
 * đợi (waiting), ngay khi một task hoàn thành, một task khác từ hàng đợi sẽ được chọn và thực thi
 */
